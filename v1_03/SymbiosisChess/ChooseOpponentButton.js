...
let getChooseOpponentButton = function ({ x, y, opponentName, elo, renderGameImage, isDesktop }) {
    ...
    let render = function (displayOutput) {
        ...
        renderGameImage(getTranslatedDisplayOutput(displayOutput, x, y));
        displayOutput.drawText(x + 80, y + 60, opponentName, 1 /* GameFont.Roboto */, 32, black);
        displayOutput.drawText(x + 80, y + 30, "Elo: " + elo, 1 /* GameFont.Roboto */, 24, black);
    };
    return {
        processFrame,
        render,
