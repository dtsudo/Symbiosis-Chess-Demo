...
let getTooltipFrame = function ({ tooltipType, isStartOfGame, gameFrame, globalState, sessionState, soundOutput, musicOutput, displayProcessing }) {
    ...
    let render = function (displayOutput) {
        ...
        displayOutput.drawRoundedRectangle(Math.floor(displayOutput.getCanvasWidth() / 2) - 300, displayOutput.getCanvasHeight() - 600, 600, 500, 10, white, true);
        displayOutput.drawRoundedRectangle(Math.floor(displayOutput.getCanvasWidth() / 2) - 300, displayOutput.getCanvasHeight() - 600, 600, 500, 10, black, false);
