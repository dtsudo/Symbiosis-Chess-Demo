...
let getSoundVolumePicker = function ({ xPos, yPos, initialVolume, color, scalingFactor }) {
    ...
    let render = function (displayOutput) {
        ...
        switch (color) {
            ...
            case 1 /* VolumePickerColor.White */:
                gameImage = currentVolume > 0 ? 2 /* GameImage.SoundOn_White */ : 3 /* GameImage.SoundOff_White */;
                dtColor = white;
                break;
        }
        displayOutput.drawImageRotatedClockwise(gameImage, 0, 0, 100, 100, xPos, yPos, 0, (128 / 2) * scalingFactor, null);
