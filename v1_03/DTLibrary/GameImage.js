let getImageNames = function () {
    return [
        ...
        23 /* GameImage.Wilber */,
        24 /* GameImage.Tux */,
        25 /* GameImage.Stockfish */,
        26 /* GameImage.SinglePlayer */,
        27 /* GameImage.QuestionMark */
    ];
};
let getFilename = function (image) {
    switch (image) {
        ...
        case 20 /* GameImage.Konqi */: return "Konqi/Mascot_konqi-app-game.png";
        case 21 /* GameImage.Katie */: return "Katie/Mascot_konqi-app-dev-katie.png";
        case 22 /* GameImage.Kiki */: return "Kiki/Kiki.png";
        case 23 /* GameImage.Wilber */: return "Wilber/wilber-big.png";
        case 24 /* GameImage.Tux */: return "Tux/tux_body_run-1.png";
        case 25 /* GameImage.Stockfish */: return "Stockfish/icon_512x512.png";
        case 26 /* GameImage.SinglePlayer */: return "Kenney/singleplayer_blue.png";
        case 27 /* GameImage.QuestionMark */: return "Kenney/question.png";
    }
};
